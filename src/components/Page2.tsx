  ...
  return (
    <div className="max-w- mx-auto bg-white shadow-md overflow-hidden">
      <div className="flex justify-between items-center bg-gray-200 p-4">
        ...
        <div className="text-2xl text-gray-800">PAGE 2</div>
      </div>
      ...
      <div className="p-6 border-b border-gray-300">
        ...
        <div className="mt-4">
          ...
          <div className="text-sm text-gray-600">PoC(検証), Production(本番環境)</div>
          <div className="text-sm text-gray-600">app-developer - アプリケーション開発, operator/sys-admin - 運用管理/システム管理</div>
        </div>
      </div>
    </div>    
  )
